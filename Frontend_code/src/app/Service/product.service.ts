...
export class ProductService {
  ...
  private categoryUrlById = 'https://localhost:5001/api/Products/findByCategoryId';

  private categoryUrl = 'https://localhost:5001/api/Products/product-category';

  private searchByName = 'https://localhost:5001/api/Products/findByNameContaining';
